// Seed data, carried over from the current ecommerce-app's
// src/services/mockData.ts so both projects describe the same catalog.
// There is no service layer wrapping it here, just a flat array.
